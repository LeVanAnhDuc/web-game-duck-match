...
# merely mentions them — a changelog, or a doc about this very file — must not
...
if [ -z "$latest" ]; then
  # First release. v1.0.0 rather than v0.1.0: the game is playable end to end, and
  # a 0.x would only invite the question of what 1.0 is waiting for.
