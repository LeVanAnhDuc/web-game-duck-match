...
| --- | --- | --- | --- | --- |
| FR-01 | Chơi một bàn match-3: swap kề nhau, tìm match, cascade, trọng lực, refill | US-01 | 1 | đang |
| FR-02 | Quân đặc biệt: sinh từ match 4 / L-T / 5, và kích hoạt đơn lẻ | US-04 | 1 | đang |
| FR-03 | Mục tiêu `score` — đạt số điểm trong N lượt | US-01 | 1 | đang |
| FR-04 | Mục tiêu `collect` — thu đủ X viên của từng màu | US-01 | 1 | đang |
| FR-05 | Chấm sao và ghi điểm cao từng màn | US-01 | 1 | đang |
| FR-06 | Bản đồ màn + mở màn tuyến tính | US-01 | 1 | đang |
| FR-07 | Lưu và đọc tiến độ cục bộ qua `ProgressRepository` | US-03 | 1 | đang |
| FR-08 | Phát hiện bế tắc và xáo bàn, không mất lượt | US-01 | 1 | đang |
