...
| [`02-requirements/nfr.md`](02-requirements/nfr.md) | Ngưỡng nào áp cho **mọi** feature, để không phải nhắc lại … | 🟢 đủ — đã rà theo dự án 04.09.2026 | thêm loại tài nguyên mới · thêm nhóm người dùng · sau sự c… |
...
| [`../.env.example`](../.env.example) | cần biến nào để chạy được dự án này? | 🟢 đủ — dự án này KHÔNG cần biến môi trường … | code đọc một biến mới (process.env.X / os.getenv / os.Gete… |
<!-- END:auto -->
